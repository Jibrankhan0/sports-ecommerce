    ...
    return (
        <div className="admin-products">
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2rem' }}>
                ...
                <button className="btn btn-primary" onClick={() => { setEditingProduct(null); setShowModal(true); }}>+ Add Product</button>
            </div>
            ...
            {showModal && (
                <div className="modal-overlay">
                    <div className="modal-box" style={{ maxWidth: '700px', width: '90%', padding: '2rem', overflowY: 'auto' }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '1.5rem' }}>
                            ...
                            <div className="form-group" style={{ gridColumn: 'span 2' }}>
                                <label className="form-label">Specifications (Format: Key:Value | Key:Value)</label>
